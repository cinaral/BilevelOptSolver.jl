...
elapsed_time = @elapsed begin
    x, status, iter_count = solve_bop(bop; max_iter=100, x_init=b.xy_init, verbosity=5, is_using_HSL=true, tol=1e-8,norm_dv_len=10, conv_dv_len=1, is_checking_min=true, is_checking_x_agree=false)
end
