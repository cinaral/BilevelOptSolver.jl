...
res = benchmark_BASBLib(; do_require_nonstrict_min=true, init_solver="PATH", solver="PATH");
CSV.write("BASBLib_results.csv", res)
res = benchmark_BOLIB(; do_require_nonstrict_min=true, init_solver="PATH", solver="PATH");
