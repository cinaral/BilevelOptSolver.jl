...
#res_min = run_all_BOLIB_examples(; verbosity=0, max_iter=50, tol=1e-7, conv_dv_len=3, do_check_x_agreem=true, do_force_hp_init=false, max_rand_restart_ct=10, do_require_strict_min=false, init_solver="PATH", solver="PATH");
