...
elapsed_time = @elapsed begin
    is_sol_valid, x, λ, iter_count, status = solve_bop(bop; max_iter=50, x_init=b.xy_init, verbosity=5, tol=1e-7, norm_dv_len=10, conv_dv_len=1, is_checking_min=false, is_checking_x_agree=false, is_forcing_inactive_inds=true, init_solver="PATH", solver="PATH")
end
