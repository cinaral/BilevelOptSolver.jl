...
res = run_all_BOLIB_examples(; verbosity=0, max_iter=50, tol=1e-6, is_checking_min=false, conv_dv_len=2, init_solver="IPOPT", solver="PATH");
#CSV.write("BOLIB_results.csv", res.df)

res_min = run_all_BOLIB_examples(; verbosity=0, max_iter=50, tol=1e-6, is_checking_min=true, conv_dv_len=2, init_solver="IPOPT", solver="PATH");
