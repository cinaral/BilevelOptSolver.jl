...
res = run_all_BOLIB_examples(; verbosity=0, max_iter=200, is_using_HSL=true, is_check_v_agreem=false, tol=1e-6, is_saving_CSV=true, norm_dv_len=10, conv_dv_len=3);
