...
res = run_all_BOLIB_examples(; verbosity=0, max_iter=100, is_using_HSL=true, tol=1e-6, is_checking_min=false, conv_dv_len=1);
#CSV.write("BOLIB_results.csv", res.df)

@info "is_checking_min TRUE"
res_no_min = run_all_BOLIB_examples(; verbosity=0, max_iter=100, is_using_HSL=true, tol=1e-6, conv_dv_len=1, is_checking_min=true, is_checking_x_agree=false);
