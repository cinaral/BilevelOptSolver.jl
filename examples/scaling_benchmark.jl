...
```
"""
function create_solve(prob; tol=1e-7, verbosity=0, init_solver="PATH", solver="PATH", max_iter=50, conv_dv_len=3, do_force_hp_init=false, do_check_x_agreem=true, max_rand_restart_ct=0)
