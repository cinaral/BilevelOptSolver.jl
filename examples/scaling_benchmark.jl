...
```
"""
function create_solve(prob; tol=1e-7, verbosity=0, init_solver="PATH", solver="PATH", max_iter=50, conv_dv_len=3, do_force_hp_init=false, do_check_x_agreem=true, max_rand_restart_ct=10)
    ...
    function solve(; x_init=prob.xy_init)
        ...
        is_sol_valid, x, λ, iter_count, status = solve_bop(bop; x_init, verbosity, tol, init_solver, solver, max_iter, conv_dv_len, do_force_hp_init, do_check_x_agreem, max_rand_restart_ct)
...
P1_10_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1());
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_20_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1());
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_30_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1());
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_40_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1());
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_50_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1());
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_60_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1());
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_70_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1());
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_80_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1());
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_90_bench = @benchmark solve_P1() seconds = 60;
...
solve_P1, _ = @btime create_solve(RobustPortfolioP1()) ;
#solve_P2, _ = @btime create_solve(RobustPortfolioP2());
P1_100_bench = @benchmark solve_P1() seconds = 60;
