...
all should solve
"""
function test_mb_2007_01(; tol=1e-7, n=10)
...
"""
function test_mb_2007_02(; tol=1e-7, n=10)
    rng = MersenneTwister(123)
    p = mb_2007_02()
...
"""
function test_bf_1982_02(; tol=1e-5, n=10)
    rng = MersenneTwister(123)
    p = bf_1982_02()
...
"""
"""
function test_ct_1982_01(; tol=1e-7, n=1)
    rng = MersenneTwister(123)
    p = ct_1982_01()
...
"""
expected to converge to the wrong local min depending on the initialization
"""
function test_mb_2007_05(; tol=1e-7, n=10)
    rng = MersenneTwister(123)
    p = mb_2007_05()
...
"""
"""
function test_mb_2007_06(; tol=1e-7, n=10)
    p = mb_2007_06()
